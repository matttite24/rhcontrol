...
/**
 * Loading state para /shifts/requests. La página es `force-dynamic` y cada
 * cambio de filtro (SubHeader) navega con un <form method="GET"> que dispara
 * un round-trip completo al servidor; sin este archivo, Next.js no muestra
 * ningún feedback pendiente y la tabla anterior queda congelada hasta que
